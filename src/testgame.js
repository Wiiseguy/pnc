import { GameActor, GameInfo } from './engine.core.ts'
import './engine.ts'
...
// Room - Bedroom
IMAGE('BedroomBG', '/data/TestAdv/Bedroom/Bedroom.png')
IMAGE('Box', '/data/TestAdv/Bedroom/Box.png')

// // Room - Left Room
IMAGE('Hallway_LeftBG', '/data/TestAdv/HallWay_Left/HallWay_LeftBG.png')
IMAGE('TestActor', '/data/TestAdv/HallWay_Left/TestActor.png')
IMAGE('Shelf', '/data/TestAdv/HallWay_Left/Shelf.png')
IMAGE('Fidget', '/data/TestAdv/HallWay_Left/Fidget.png')
// Room - Right Room
IMAGE('Hallway_RightBG', '/data/TestAdv/HallWay_Right/HallWay_RightBG.png')
IMAGE('Painting', '/data/TestAdv/HallWay_Right/Painting.png')
IMAGE('WallSafe', '/data/TestAdv/HallWay_Right/WallSafe.png')

// Closet
IMAGE('ClosetBG', '/data/TestAdv/Closet/ClosetBG.png')
IMAGE('ClosetShadow', '/data/TestAdv/Closet/ClosetShadow.png')
IMAGE('Toolbox', '/data/TestAdv/Closet/Toolbox.png')

// Room - Kitchen
IMAGE('KitchenBG', '/data/TestAdv/KitchenRoom/KitchenBG.png')
IMAGE('FridgeDoorClosed', '/data/TestAdv/KitchenRoom/FridgeDoorClosed.png')
IMAGE('FridgeDoorOpen', '/data/TestAdv/KitchenRoom/FridgeDoorOpen.png')
IMAGE('Cheese', '/data/TestAdv/KitchenRoom/Cheese.png')

IMAGE('BatStrip', '/data/TestAdv/SFX/bat_strip.png')
// Sound effects and stuff
SOUND('TestActorScream', '/data/TestAdv/SFX/scream.wav')
SOUND('clue', '/data/TestAdv/SFX/sfx-clue.wav', { volume: 0.5 })
SOUND('thud', '/data/TestAdv/SFX/thud1.wav')
SOUND('move', '/data/TestAdv/SFX/thud2.wav')
SOUND('menu', '/data/TestAdv/SFX/menu.wav')
SOUND('kitchen', '/data/TestAdv/SFX/62215.wav')
SOUND('bg', '/data/TestAdv/SFX/chill.mp3', { volume: 0.3 }) // Credit: https://www.looperman.com/loops/detail/289801/lenoxbeatmaker-sativaskunk-free-146bpm-jazz-electric-guitar-loop

// Mouse Pointers
IMAGE('cur_pointer', '/data/TestAdv/cur_pointer.png')
IMAGE('cur_walk', '/data/TestAdv/cur_walk.png')
IMAGE('cur_pickup', '/data/TestAdv/cur_pickup.png')
...
// Animations
ANIMATION('AnimatedBats', 'BatStrip', 200, [3, 1]) // 3 columns, 1 row (3 frames)
...
ROOM('Hallway_Left', () => {
    ...
    CLICK('mouseHole', () => {
        ...
        if (gotCheese) {
            ...
            MOVEACTOR('TestActor', 700, 160, 1000, true, {
                easing: 'easeInElastic(1, .6)'
            })
            hasTestActorMoved = true
        } else {
            SHOWTEXT(
                'I hear something moving around in there. I hear something moving around in there. I hear something moving around in there.'
            )
        }
    })
...
ROOM('TestRoom', ctx => {
    ...
    CLICK('Reset', _ => {
        ...
        score = 0
        PLAYSOUND('TestActorScream', { rate: 0.8 + Math.random() * 0.4 })
    })
    ...
    for (let i = 0; i < numBalls; i++) {
        ...
        CLICK('Ball' + i, ball => {
            score++
            HIDEACTOR(ball.name)
            PLAYSOUND('thud', { rate: 0.8 + Math.random() * 0.4 })
        })
    }
...
BEHAVIOR('drag', {
    ...
    update(actor, p5, gameInfo) {
        ...
        if (p5.mouseIsPressed) {
            if (actor.boundingBox.contains(p5.mouseX, p5.mouseY) && !gameInfo._isDragging) {
                // gameInfo check is to prevent other objects from being dragged
                if (!actor.isDragging) {
